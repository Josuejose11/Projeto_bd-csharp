        ...
        switch (opcao)
        {
            ...
            case "1":
                ...
                while (true)
                {
                    ...
                    Update(connection,"valor_dps",valorDespesa,id);
            ...
            case "3":
                ...
                while (true)
                {
                    Console.Write(
                        "Nova categoria " +
                        "(Alimentação, Transporte, Saúde, Educação ou Lazer): "
                    );
            ...
            case "4":
                ...
                while (true)
                {
                    Console.Write(
                        "Nova descrição " +
                        "(Digite 0 caso não queira informar): "
                    );
                    ...
                    {
                        Console.WriteLine(
                            "A descrição não pode ter mais de 300 caracteres."
                        );
                        Console.WriteLine("---------------");
                        continue;
                    }
